...
class ST7789(object):
    ...
    def __init__(self, spi, mode=3, rst=27, dc=25, cs=24, led=24, gpio=None, width=ST7789_TFTWIDTH,
        height=ST7789_TFTHEIGHT, rotation=180, y_offset=0):
        """
        spi = spi driver
        mode =
        dc =
